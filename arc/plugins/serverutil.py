...
class ServerUtilPlugin(ProtocolPlugin):
    ...
    def commandCrashMe(self, parts, fromloc, overriderank):
        "/crashme - Guest\nCrashes you."
        self.client.sendNormalMessage("This crashes you&a ")
        self.client.sendNormalMessage("Or&a maybe this")
        self.client.sendNormalMessage("Or this?&&a")
        self.client.sendNormalMessage("Perhaps this.&& ")
        self.client.sendNormalMessage("&a&a&a&a&aa&")
        self.client.sendNormalMessage("How about Josh &&& me?")